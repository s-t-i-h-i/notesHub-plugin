...
const entryPoints = ['test/settings-render.ts', 'test/update-plan.ts', 'test/list-query.ts', 'test/install-record.ts', 'test/nocode.ts', 'test/links.ts', 'test/moderation.ts'];
let failed = false;
